...
def init_leds():
    """
    Initialise the Leds engine of NAO.
    :return: Leds instance
    """
...
def close_down(tracker, motion, event_broker):
    ...
    :return:
    """
    print "Session finished by user, shutting down"
    # Stop tracker.
    tracker.stopTracker()
