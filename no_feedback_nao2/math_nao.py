...
def rijgen(tts, a, b, operator):
    ...
    if operator == "erbij":
        ...
        if units < 0 and int(tientallen) > 20:
            ...
            tts.say("We moeten dus even een tiental lenen.")
            if len(str(b)) > 1:
                tts.say(str(int(digits_a[0])*10-int(digits_b[0])*10) + " wordt dan " + str(int(digits_a[0])*10-int(digits_b[0])*10-10))
                print("Lenen: " + str(int(digits_a[0])*10-int(digits_b[0])*10) + " wordt dan " + str(int(digits_a[0])*10-int(digits_b[0])*10-10))
            else:
                tts.say(str(int(digits_a[0])*10) + " wordt dan, " + str(int(digits_a[0])*10-10))
                print("Lenen: " + str(int(digits_a[0])*10) + " wordt dan, " + str(int(digits_a[0])*10-10))
            ...
            uitkomst = int(a) - int(b)
            if len(str(b)) > 1:
                tts.say(str(int(digits_a[0])*10-int(digits_b[0])*10-10) + ", erbij " + str(tussenstop) + ", is " + str(uitkomst))
                print("Rest: " + str(int(digits_a[0]) * 10 - int(digits_b[0]) * 10 - 10) + " erbij " + str(
                    tussenstop) + " is " + str(uitkomst))
            else:
                tts.say(str(int(digits_a[0])*10-10) + ", erbij " + str(tussenstop) + ", is " + str(uitkomst))
                print("Rest: " + str(int(digits_a[0])*10-10) + " erbij " + str(
                    tussenstop) + " is " + str(uitkomst))
