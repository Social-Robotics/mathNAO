...
def explain_session(tts):
    ...
    tts.say("Maak je een foutje bij het rekenen, dan probeer ik je uit te leggen, hoe het wel moet.")
...
def explain_working(tts):
    ...
    tts.say("Denk eraan dat je alleen tegen mij kan praten als mijn ogen blauw zijn.")
