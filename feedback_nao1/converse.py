...
def open_conversation(tts):
    tts.say("Welkom! Mijn naam is Pixel. Wat is jouw naam?.")


def explain_session(tts):
    tts.say("Hallo! Leuk dat je met mij sommetjes wil maken.")
    ...
    tts.say("Wij gaan 20 minuten lang rekensommetjes oefenen, die jij uit je hoofd moet proberen uit te rekenen.")
    tts.say("Gaat dit goed, dan leer ik jou een dansje.")
    tts.say("Maak je een foutje, dan probeer ik je uit te leggen, hoe het wel moet.")
